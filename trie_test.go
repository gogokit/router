	...
	Convey("TestAddHandler", t, func() {
		Convey("no_conflict", func() {
			...
			*/
			...
			root := &node{}
			for _, v := range paths {
				root.AddHandler([]byte(v), func(rw http.ResponseWriter, r *http.Request, up []UrlParam) {})
			}
		...
		*/
		...
		Convey("match_absolute_path", func() {
			...
			for _, v := range ppaths {
				h, param, tsr := root.GetHandler([]byte(v))
		...
		Convey("match_param", func() {
			h, param, tsr := root.GetHandler([]byte("/aa/param1/"))
			So(h, ShouldNotEqual, nil)
			...
			h, param, tsr = root.GetHandler([]byte("/aa/param1/param2/"))
			So(h, ShouldNotEqual, nil)
			...
			h, param, tsr = root.GetHandler([]byte("/aa/param1/param2/a/param3"))
			So(h, ShouldNotEqual, nil)
			...
			h, param, tsr = root.GetHandler([]byte("/bbb/param1"))
			So(h, ShouldNotEqual, nil)
			So(len(param), ShouldEqual, 1)
		...
		Convey("test_tsr", func() {
			...
			h, param, tsr = root.GetHandler([]byte("/aa/param1/param2/a"))
			So(h, ShouldEqual, nil)
			So(len(param), ShouldEqual, 0)
			So(tsr, ShouldEqual, true)
			...
			h, param, tsr = root.GetHandler([]byte("/bbb"))
			So(h, ShouldEqual, nil)
			So(len(param), ShouldEqual, 0)
			So(tsr, ShouldEqual, true)

			// "/aa/:version1/:version2/b:version3/*all",
			h, param, tsr = root.GetHandler([]byte("/aa/p1/p2/b"))
			So(h, ShouldEqual, nil)
			So(len(param), ShouldEqual, 0)
			So(tsr, ShouldEqual, true)

			h, param, tsr = root.GetHandler([]byte("/bb"))
			So(h, ShouldEqual, nil)
			So(len(param), ShouldEqual, 0)
			So(tsr, ShouldEqual, false)

			h, param, tsr = root.GetHandler([]byte("/c/p1/p2/p3"))
			So(h, ShouldEqual, nil)
			So(len(param), ShouldEqual, 0)
			So(tsr, ShouldEqual, false)
			...
			h, param, tsr = root.GetHandler([]byte("/d/p"))
			So(h, ShouldEqual, nil)
			So(len(param), ShouldEqual, 0)
			So(tsr, ShouldEqual, true)
		})
